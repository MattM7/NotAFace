package processing.test.notafaceandroideditionv4;
...
public class NotAFaceAndroidEditionV4 extends PApplet {
...
class face {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "NotAFaceAndroidEditionV4" };
    if (passedArgs != null) {
